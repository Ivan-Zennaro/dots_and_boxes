...
public class ServerTelnet {
    ...
    public ServerTelnet(int port, String quitCommand) {
        this.port = port;
                ...
                try {
                    ...
                    executorService.submit(() -> {
                        try (socket) {
                            ...
                            ClientTelnet gameForClient = new ClientTelnet(br, bw, cliTelnet);
                            ...
                            while (true) {
                                ...
                                if (command.equals("NEW")) {
                                    gameForClient = new ClientTelnet(br, bw, new CliTelnet(3,3, br, bw));
                                    gameForClient.startGameServer(quitCommand);
                                }
